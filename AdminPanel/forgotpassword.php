...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="services/reset_pass.php" method="POST" class="login">
      ...
      <div class="row " style=" margin-top: -13px;">
        ...
        <div class="col-xs-10 col-xs-offset-1">
          <button type="submit" class="btn btn-primary btn-block btn-flat btn-log" >Reset Password</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
	<div class="log-nav pull-down">
		<a  class="btn btn-link pull-left" style="font-size: 12px;color: blue;" href="login.php">Go back to Login</a>
	</div>
	</div>
  <!-- /.login-box-body -->
</div>
